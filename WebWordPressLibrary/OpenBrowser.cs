...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    public partial class OpenBrowser : ITestModule
    {
        ...
        public OpenBrowser()
        {
            ...
            browser = "http://bitly.com/wp_demo";
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("775ca869-ebe1-4354-9349-6f02593d05bf")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Website", "Opening web site 'http://webtest.ranorex.org' with browser specified by variable $browser in maximized mode.", new RecordItemIndex(0));
            Host.Current.OpenBrowser("http://webtest.ranorex.org", browser, "", false, true, false, false, false, true);
